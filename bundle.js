...
"use strict";
/*
 * This file originally contained a test web app that uses the AppAuthJS library.
 * It has been modified to demonstrate how to support the MSF API.
 * The copyright notice from the original version appears below.
 */
...
// Constants
var OIDC_URL = 'https://hydra-public.prod.m3.scopelypv.com';
var API_ROOT = 'https://api.marvelstrikeforce.com';
var App = /** @class */ (function () {
    // Constructor
    function App(CLIENT_ID, SCOPE, REDIRECT_URI) {
        var _this = this;
        this.CLIENT_ID = CLIENT_ID;
        this.SCOPE = SCOPE;
        this.REDIRECT_URI = REDIRECT_URI;
        // Initialize Notifiers/Handlers
        ...
        // Hook Notifier up to Authorization Handler
        ...
        this.notifier.setAuthorizationListener(function (request, response, error) {
            ...
            if (response) {
                _this.authorizationRequest = request;
                _this.code = response.code;
            }
        });
    }
    // ASYNC function meant to be called on page load
    // Returns true if the player has logged in.
    // Returns false or throws an error otherwise.
    App.prototype.checkForAuthorizationResponse = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.loggedInPromise) {
                    this.loggedInPromise = this.checkForAuthorizationResponseInternal();
                }
                return [2 /*return*/, this.loggedInPromise];
            });
        });
    };
    // Called to redirect the user to log in
    App.prototype.makeAuthorizationRequest = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = new authorization_request_1.AuthorizationRequest({
    ...
    // If the player is logged in, returns their preferred language, if we have it
    App.prototype.getPlayerLang = function () {
        return this.claims && this.claims.lang;
    };
    // This is the main function for calling the API.
    //
    // Step 1: It attempts to call the given route and method of MSF API using the
    // logged in player's tokens.
    //
    // Step 2: If the access token is expired, it tries to refresh the token. If the
    // refresh is successful, it saves the new token set.
    //
    // Step 3: It re-attempts the route with the refreshed tokens.
    //
    // Accordingly, the result of the function will normally be a fetch response from
    // the intended route, either from the initial attempt or the re-attempt. The
    // caller can assume that any token refresh, if possible, was carried out. Any
    // remaining 403 error is then an incurable result.
    App.prototype.fetch = function (route, method) {
        if (method === void 0) { method = "get"; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, response1, e_1, response3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = !this.loggedInPromise;
                        if (_a) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loggedInPromise];
                    case 1:
                        _a = !(_b.sent());
                        _b.label = 2;
                    case 2:
                        ...
                        return [4 /*yield*/, this.apiFetch(route, method)];
                    case 3:
                        response1 = _b.sent();
                    ...
                    case 4:
                        _b.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, this.checkRefresh()];
                    case 5:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 6:
                        e_1 = _b.sent();
                        logger_1.log('Error refreshing tokens', e_1);
                        return [2 /*return*/, response1];
                    case 7: return [4 /*yield*/, this.apiFetch(route, method)];
                    case 8:
                        response3 = _b.sent();
                        return [2 /*return*/, response3];
                }
            });
        });
    };
    // Clears local data
    App.prototype.clearLocal = function () {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger_1.log('Clearing Local');
                        this.loggedInPromise = Promise.resolve(false);
                        if (!this.ongoingRefresh) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        logger_1.log('Waiting for ongoing refresh to complete');
                        return [4 /*yield*/, this.ongoingRefresh];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                    ...
                    case 4:
                        ...
                        this.code = undefined;
                        this.setTokenResponse(undefined, true);
                        logger_1.log('Local Cleared');
                        return [2 /*return*/];
                }
            });
        });
    };
    // Debug function to expire access token, to test refresh flow
    App.prototype.debugExpireAccessToken = function () {
        if (this.tokenResponse) {
            this.tokenResponse.accessToken = "expired";
        }
    };
    /////////////////////////
    //  PRIVATE FUNCTIONS  //
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, authorization_service_configuration_1.AuthorizationServiceConfiguration.fetchFromIssuer(OIDC_URL)];
                    case 1:
                        _a.configuration =
                            _b.sent();
                        logger_1.log('Fetched service configuration', this.configuration);
                        _b.label = 2;
                    case 2: return [2 /*return*/, this.configuration];
                }
            });
        });
    };
    App.prototype.checkForAuthorizationResponseInternal = function () {
        return __awaiter(this, void 0, void 0, function () {
            var json;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authorizationHandler.completeAuthorizationRequestIfPossible()];
                    case 1:
                        _a.sent();
                        if (!this.code) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.makeTokenRequestWithCode()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, true];
                    case 3:
                        json = window.localStorage.getItem("tokenResponse");
                        if (!json) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.loadStoredTokenResponse(json)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/, true];
    ...
    App.prototype.makeTokenRequestWithCode = function () {
        return __awaiter(this, void 0, void 0, function () {
            var extras, tokenRequest;
            return __generator(this, function (_a) {
                logger_1.log('Making token request with code');
                if (!this.code) {
                ...
                tokenRequest = new token_request_1.TokenRequest({
                    client_id: this.CLIENT_ID,
                    redirect_uri: this.REDIRECT_URI,
                ...
                return [2 /*return*/, this.makeTokenRequest(tokenRequest)];
            });
        });
    };
    App.prototype.checkRefresh = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.ongoingRefresh) {
                            logger_1.log('Returning ongoing refresh');
                            return [2 /*return*/, this.ongoingRefresh];
                        }
                        logger_1.log('Starting new refresh');
                        this.ongoingRefresh = this.makeTokenRequestWithRefreshToken();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, , 3, 4]);
                        return [4 /*yield*/, this.ongoingRefresh];
    ...
    App.prototype.makeTokenRequestWithRefreshToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tokenRequest;
            return __generator(this, function (_a) {
                logger_1.log('Making token request with Refresh Token');
    ...
    App.prototype.makeTokenRequest = function (tokenRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        return [4 /*yield*/, this.tokenHandler.performTokenRequest(config, tokenRequest)];
                    case 2:
                        response = _a.sent();
                        logger_1.log('Token request complete ', response);
                        this.setTokenResponse(response, true);
                        return [2 /*return*/];
                }
            });
        });
    };
    App.prototype.setTokenResponse = function (tokenResponse, persist) {
        if (persist === void 0) { persist = false; }
        this.tokenResponse = tokenResponse;
        this.code = undefined;
        var idToken = tokenResponse && tokenResponse.idToken;
        this.claims = idToken ? JSON.parse(atob(idToken.split('.')[1])) : undefined;
        if (persist) {
            if (tokenResponse) {
                var tokenResponseJson = tokenResponse.toJson();
                var json = JSON.stringify(tokenResponseJson);
                window.localStorage.setItem("tokenResponse", json);
                logger_1.log('Persisted token response');
            }
            else {
                window.localStorage.removeItem("tokenResponse");
                logger_1.log('Cleared token response');
            }
        }
    };
    App.prototype.loadStoredTokenResponse = function (json) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenResponseJson, tokenResponse;
            return __generator(this, function (_a) {
                logger_1.log('Loading stored tokens');
                tokenResponseJson = JSON.parse(json);
                tokenResponse = new token_response_1.TokenResponse(tokenResponseJson);
                this.setTokenResponse(tokenResponse);
                if (tokenResponse.isValid()) {
                    return [2 /*return*/];
                }
                return [2 /*return*/, this.makeTokenRequestWithRefreshToken()];
            });
        });
    };
    App.prototype.apiFetch = function (route, method) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                logger_1.log('Making API request with Access Token');
                if (!this.tokenResponse || !this.tokenResponse.accessToken) {
                    throw new Error('Missing Access Token');
                }
                return [2 /*return*/, fetch(API_ROOT + route, {
                        method: method,
                        headers: {
...
},{"../authorization_request":2,"../authorization_request_handler":3,"../authorization_service_configuration":5,"../logger":9,"../redirect_based_handler":11,"../token_request":13,"../token_request_handler":14,"../token_response":15}],2:[function(require,module,exports){
"use strict";
/*
 * Copyright 2017 Google Inc.
 *
